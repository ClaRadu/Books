                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
					<div class="panel panel-default">
						...
						<?php if(count($authors) > 0): ?>
							...
							<tr><th>ID</th><th>first name</th><th>last name</th><th>modify</th><th>delete</th>
								<td><a style="background-color:lightblue; color:white;" href="<?php echo e(url('author/add')); ?>">Add new</a></td>
							</tr>
							...
							<tr>
								<td class="table-text"><?php echo e($a->id); ?></td>
								<td class="table-text"><?php echo e($a->first_name); ?></td>
								<td class="table-text"><?php echo e($a->last_name); ?></td>
								<!-- update -->
								<td>
									<a style="background-color:green; color:white;" href='author/<?php echo e($a->id); ?>'>Update</a>
								</td>
								<!-- del-->
								<td>
									<a style="background-color:red; color:white;" href='author/del/<?php echo e($a->id); ?>'>Delete</a>
								</td>
							</tr>
...
<?php /**PATH F:\aXamppProj\larav\Books\resources\views/authors/index.blade.php ENDPATH**/ ?>