                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
								...
								<a href="<?php echo e(url('/authors')); ?>" class="underline text-gray-900 dark:text-white">
								Authors</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
								<a href="<?php echo e(url('/books')); ?>" class="underline text-gray-900 dark:text-white">
								Books</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
								<a href="<?php echo e(url('/publishers')); ?>" class="underline text-gray-900 dark:text-white">
								Publishers</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">
								<a href="<?php echo e(url('/welcome')); ?>" class="underline text-gray-900 dark:text-white">
								Laravel</a></div>
                            </div>
...
<?php /**PATH F:\aXamppProj\larav\Books\resources\views/home.blade.php ENDPATH**/ ?>